package kr.or.test;
/**
 * 이 클래스는 메서드 기만의 Step1클래스를 객체기반의 클래스로 변경한 클래스. 
 * @author 김지애
 *
 */
class MemberVO{
	...
	//하나씩 출력하기 힘들때 자동으로 멤버변수값을 출력하는 명령  toString 생성(아래)
	@Override
	public String toString() {
		return "MemberVO 내용출력하기[name=" + name + ", age=" + age + ", phoneNum=" + phoneNum + "]";
	}
...
public class Step2{
	...
	public static void main(String[] args) {
		...
		//클래스는 아래처러 직접 접근해서 메서드나 변수를 사용할 수 없음
		//외부클래스로 접근하려면,객체(실행가능한=메모리로딩)로 만들어야 가능함.
		//Static 예약어는 컴파일시 메모리에 로딩이 되게 명시
		//메번 Static으로 만들면 메모리 가득차서 프로실행이 느려지거나 멈춤.
		//MemberService.printMember(members);
