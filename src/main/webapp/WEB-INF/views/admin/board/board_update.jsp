        ...
        <div class="card card-primary">
          ...
          <form name="form_write"  method="post" action="/admin/board/board_update" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group div_file_delete">
              <!-- 위 div_file_delete 영역이름은 첨부파일을 개별 Ajax 삭제할때 필요 -->
                ...
                <div class="input-group">
                    ...
                    <c:if test="${boardVO.save_file_names[idx] != null}">
                     <p class="text-muted">
                      	<a href="/download?save_file_name=${boardVO.save_file_name[idx]}&real_file_name=${boardVO.real_file_names[idx]}">첨부파일 명[삭제]
                     ${boardVO.real_file_names[idx]}
                     </a>
                     &nbsp;<button type = "button" class="btn btn-info btn_file_delete">삭제</button>
                     <input type ="hidden" name="save_file_name" value="${boardVO.save_file_name[idx]}"
                     </p>
                    </c:if>
                  </div>
                  <div class="mb-2"></div>
